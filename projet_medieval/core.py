...
class Viewer(Node):
    ...
    def text_help(self):
        print("Viewer help : ")
        print("Utiliser le scroller de la souris pour zoomer et dézoomer")
        print("Maintener la touche gauche de la souris pour déplacer la caméra autour du centre")
        print("Le son est activé par défaut : ")
        print("\t \t Pour le désactiver, appuyer sur la touche A (Qwerty) ou Q (Azerty)")
        print("\t \t Pour le réactiver, appuyer sur la touche S")
        print("Pour animer le bûcheron, les gardes et la porte de la cité, appuyer sur la touche ESPACE")
        print("Pour quitter la scène, appuyer sur Q (Qwerty) ou A (Azerty) ou Echap")
