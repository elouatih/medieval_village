...
import assimpcy
from texture_mesh import Texture, TexturedMesh
from phong_mesh import PhongMesh
from skinning_mesh import SkinnedMesh, SkinningControlNode, MAX_BONES, MAX_VERTEX_BONES
import numpy as np




def load_phong_textured(file, shader, light_dir, tex_file=None):
    ...
    for mesh in scene.mMeshes:
        ...
        mesh = TexturedMesh(shader, mat['diffuse_map'], attributes, mesh.mFaces, k_d=mat.get('COLOR_DIFFUSE', (1, 1, 1)),
